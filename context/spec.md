...
**Tổng hiện tại: 31 tool** (10 read + 21 write) — đã đối chiếu trực tiếp với `registerTool()` trong `src/mcp/server.ts` (2026-08-19) để đảm bảo con số này không lệch code thật.
