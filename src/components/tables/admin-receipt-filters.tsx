...
// Base UI's Select needs a defined item value for "no filter" — same reasoning as admin-expense-filters.tsx.
const ALL_SENTINEL = "all";

type AdminReceiptFiltersProps = {
  adminOptions: FilterOption[];
};

/** Month/Admin filter row for Admin Receipts (spec §13, §20) — no category or Page/Employee here. */
export function AdminReceiptFilters({ adminOptions }: AdminReceiptFiltersProps) {
